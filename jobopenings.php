...
<div id="jobDetailsBox22" class="job-details-box">
    <h3>The Opportunity: Quality Assurance Engineer</h3>
    <p>
    ...
    <h3>A Day in the Life:</h3>
    <ul id="req">
        <li>Collaborate with product managers and developers to understand software requirements and user stories.</li>
        <li>Design and execute comprehensive test plans, test cases, and test scripts for both manual and automated testing.</li>
        <li>Conduct functional, regression, and performance testing to ensure software meets quality standards.</li>
        <li>Identify, document, and track software defects using bug tracking tools.</li>
        <li>Work closely with development teams to reproduce and isolate bugs for efficient resolution.</li>
        <li>Participate in agile ceremonies, including sprint planning, daily stand-ups, and sprint reviews.</li>
        <li>Contribute to the development and maintenance of automated test scripts for continuous integration and deployment.</li>
        <li>Provide clear and concise reports on test results and test coverage to stakeholders.</li>
    </ul>
    <br>
    <h3>Role Progression:</h3>
    <p>Within 1 month, you will:</p>
    <ul id="req">
        <li>Complete the onboarding program, gaining insights into our organization's structure, culture, and ongoing software development projects.</li>
        <li>Familiarize yourself with our specific quality assurance processes, tools, and testing environments.</li>
    </ul>
    <p>Within 6 months, you will:</p>
    <ul id="req">
        <li>Independently design and execute test plans for new features and product releases.</li>
        <li>Contribute to the development and improvement of QA processes and methodologies.</li>
        <li>Participate in automated testing initiatives and contribute to the expansion of our automated testing suite.</li>
        <li>Mentor and assist junior QA team members, fostering a collaborative and knowledge-sharing team culture.</li>
    </ul>
    <br>
    <h3>Requirements About You:</h3>
    <ul id="req">
        <li>3+ years of experience as a Quality Assurance Engineer or a related role.</li>
        <li>Strong understanding of software development life cycle (SDLC) and QA methodologies.</li>
        <li>Experience in both manual and automated testing, with proficiency in testing tools and frameworks.</li>
        <li>Knowledge of scripting languages for test automation (e.g., Selenium, Python, Java).</li>
        <li>Familiarity with version control systems (e.g., Git) and continuous integration tools.</li>
        <li>Excellent analytical and problem-solving skills, with a keen attention to detail.</li>
        <li>Ability to work independently and collaboratively in an agile development environment.</li>
...
<div id="applyForm">
    <h3 style="color: white; display: flex; justify-content: center;">Add your CV</h3>
    <br>
    <form onsubmit="return validateApplyForm('cv24', 24)">
        <label for="cv" style="color: white; margin-left: 2.5em;">Upload your CV:   </label>
        <input type="file" id="cv24" name="cv" accept=".pdf, .doc, .docx" style="margin-left: 1em;">
        <br>
        <button type="submit" id="butoniApply"><b>Apply</b></button>
    </form>
</div>

<a href="#" class="close-btn" onclick="closeJobDetails22()">Close</a>
</div>
<div id="jobDetailsBox23" class="job-details-box">
    <h3>The Opportunity: Software Engineer</h3>
    <p>
    ...
    <h3>A Day in the Life:</h3>
    <ul id="req">
        <li>Collaborate with cross-functional teams to understand software requirements and design efficient solutions.</li>
        <li>Write clean, maintainable, and efficient code for software applications.</li>
        <li>Conduct unit testing and debugging to ensure software functionality meets specifications.</li>
        <li>Participate in code reviews to maintain code quality and share knowledge with team members.</li>
        <li>Stay updated on emerging technologies and contribute to the adoption of new tools and practices.</li>
        <li>Work on both new development projects and enhancements to existing software.</li>
        <li>Troubleshoot and resolve software defects and issues in a timely manner.</li>
    </ul>
    <br>
    <h3>Role Progression:</h3>
    <p>Within 1 month, you will:</p>
    <ul id="req">
        <li>Complete the onboarding program, gaining insights into our development processes, tools, and team dynamics.</li>
        <li>Familiarize yourself with our coding standards, version control systems, and project workflows.</li>
    </ul>
    <p>Within 6 months, you will:</p>
    <ul id="req">
        <li>Take ownership of specific software components, demonstrating proficiency in their design and functionality.</li>
        <li>Collaborate on complex projects, contributing to architectural decisions and codebase improvements.</li>
        <li>Participate in knowledge-sharing sessions and mentor junior team members.</li>
        <li>Engage in ongoing professional development to stay abreast of industry trends and advancements.</li>
    </ul>
    <br>
    <h3>Requirements About You:</h3>
    <ul id="req">
        <li>3+ years of experience in software development, with a focus on building scalable and maintainable applications.</li>
        <li>Proficiency in programming languages such as Java, C++, or Python.</li>
        <li>Experience with software development methodologies and best practices.</li>
        <li>Strong problem-solving skills and attention to detail.</li>
        <li>Ability to work both independently and collaboratively within a team environment.</li>
        <li>Bachelor’s or Master’s degree in Computer Science, Software Engineering, or a related field.</li>
        <li>Familiarity with agile development processes is a plus.</li>
    </ul>
...
<div id="applyForm">
    <h3 style="color: white; display: flex; justify-content: center;">Add your CV</h3>
    <br>
    <form onsubmit="return validateApplyForm('cv25', 25)">
        <label for="cv" style="color: white; margin-left: 2.5em;">Upload your CV:   </label>
        <input type="file" id="cv25" name="cv" accept=".pdf, .doc, .docx" style="margin-left: 1em;">
        <br>
        <button type="submit" id="butoniApply"><b>Apply</b></button>
    </form>
</div>

<a href="#" class="close-btn" onclick="closeJobDetails23()">Close</a>
</div>
